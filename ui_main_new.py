...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setStyleSheet("background-color: rgb(255, 170, 127);border-radius:3px;")
        ...
        self.gridLayout.addWidget(self.doubleSpinBox, 0, 1, 3, 1)
        ...
        self.label_6.setStyleSheet("background-color: rgb(255, 170, 127);border-radius:3px;")
        ...
        self.doubleSpinBox_4.setProperty("value", 0)
        ...
        self.doubleSpinBox_5.setProperty("value", 0)
        ...
        self.doubleSpinBox_6.setProperty("value", 0)
        ...
        self.label_11.setStyleSheet("background-color: rgb(255, 170, 127);border-radius:3px;")
        ...
        self.doubleSpinBox_9.setProperty("value", 0)
        ...
        self.doubleSpinBox_10.setProperty("value", 0)
        ...
        self.doubleSpinBox_11.setProperty("value", 0)
        ...
        self.doubleSpinBox_8.setProperty("value", 0)
...
"background-color: rgb(85, 170, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "MP-HM Adsorption Prediction Platform"))
        self.groupBox.setTitle(_translate("MainWindow", "Input"))
        self.label_2.setText(_translate("MainWindow", "MP properties"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p>SSA (m<span style=\" vertical-align:super;\">2</span>/g)</p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "HM properties"))
        self.label_7.setText(_translate("MainWindow", "Molar mass(g/mol)"))
        self.label_8.setText(_translate("MainWindow", "Eletronegativity"))
        self.label_9.setText(_translate("MainWindow", "Hydrated radius (Å)"))
        self.label_11.setText(_translate("MainWindow", "Experimental conditions"))
        self.label_12.setText(_translate("MainWindow", "HM concentration (mg/L)"))
        self.label_13.setText(_translate("MainWindow", "Temperature (°C)"))
        self.label_14.setText(_translate("MainWindow", "pH"))
        self.label_15.setText(_translate("MainWindow", "MP concentration (g/L)"))
        ...
        self.groupBox_4.setTitle(_translate("MainWindow", "Langmuir Adsorption Isotherm"))
