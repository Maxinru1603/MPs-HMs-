...
class myWindow(QtWidgets.QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        #
        self.list = [10, 20, 40, 60, 80, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 900, 1000]
        self.ce_list = []
        self.new_ce_list = []
    ...
    def pre_Qmax(self):
        self.SSA = self.doubleSpinBox.value()
        self.Molar_mass = self.doubleSpinBox_4.value()
        self.Eletronegativity= self.doubleSpinBox_5.value()
        self.Hydrated_radius = self.doubleSpinBox_6.value()
        self.MP_con = self.doubleSpinBox_8.value()
        self.HM_con = self.doubleSpinBox_9.value()
        self.temeraputre = self.doubleSpinBox_10.value()
        self.PH = self.doubleSpinBox_11.value()
        X_test_list = [self.SSA,self.Molar_mass,self.Eletronegativity,self.Hydrated_radius,self.HM_con,self.MP_con,self.temeraputre,self.PH]
